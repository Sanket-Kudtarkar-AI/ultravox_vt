          ...
          {activeTab === 'settings' && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-dark-700/30 p-4 rounded-lg border border-dark-600/50">
                  <Input
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-8 gap-2 mb-2 p-3 bg-dark-700/10 rounded-lg border border-dashed border-dark-600/50">
                  <div className="md:col-span-2">
                    <input
                      type="text"
