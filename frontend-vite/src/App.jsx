...
function App() {
    ...
    const renderNotification = () => {
        ...
        return (
            <div className={`fixed top-4 right-4 z-50 max-w-md p-4 rounded-lg shadow-xl border ${bgColor} backdrop-blur-sm animate-slide-in-left`}>
    ...
    return (
        <div className="flex h-screen w-screen bg-gradient-to-b from-gray-900 to-gray-950 overflow-hidden">
            {/* Sidebar */}
            <Sidebar
            ...
            {/* Main Content */}
            <div className="flex-1 overflow-auto bg-gradient-to-b from-dark-900 to-dark-950 text-gray-200">
                {renderNotification()}
                {renderContent()}
            </div>
